...
IF NOT EXISTS(SELECT 1 FROM CODE_VALUE WHERE CODE_ID = 7 AND CODE_VALUE = 'IIFL')
BEGIN
 INSERT INTO CODE_VALUE VALUES(7, 'IIFL', 'IIFL', NULL,NULL)
END
GO

-- Code 8
IF NOT EXISTS(SELECT 1 FROM CODE_VALUE WHERE CODE_ID = 8 AND CODE_VALUE = 'PAIS')
BEGIN
 INSERT INTO CODE_VALUE VALUES(8, 'PAIS', '5 Paisa', NULL,NULL)
END
GO

IF NOT EXISTS(SELECT 1 FROM CODE_VALUE WHERE CODE_ID = 8 AND CODE_VALUE = 'GROW')
BEGIN
 INSERT INTO CODE_VALUE VALUES(8, 'GROW', 'Groww', NULL,NULL)
END
GO

IF NOT EXISTS(SELECT 1 FROM CODE_VALUE WHERE CODE_ID = 8 AND CODE_VALUE = 'MOTI')
BEGIN
 INSERT INTO CODE_VALUE VALUES(8, 'MOTI', 'Molilal Oswal', NULL,NULL)
END
GO

IF NOT EXISTS(SELECT 1 FROM CODE_VALUE WHERE CODE_ID = 8 AND CODE_VALUE = 'IIFL')
BEGIN
 INSERT INTO CODE_VALUE VALUES(8, 'IIFL', 'IIFL Securities', NULL,NULL)
END
GO
